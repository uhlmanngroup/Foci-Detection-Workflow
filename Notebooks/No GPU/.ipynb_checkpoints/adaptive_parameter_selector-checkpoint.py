...
class AdaptiveParameterSelector:
    ...
    def save_reduced_parameters(self, save_path: str, channel: str):
        """
        Save optimized parameters for this tracker.
    ...
    def load_reduced_parameters(self, load_path: str, channel: str) -> np.ndarray:
        """
        Load pre-optimized parameters for this channel.
        ...
        Returns:
        --------
        np.ndarray : The loaded parameter combinations
        """
        import pickle
    ...
    def visualize_parameter_space(self, channel='TRITC', save_path=None):
        ...
        plt.close(fig) # Otherwise the Plot is being shown at the end of the picture analysis
        return fig
